...
class PurchaseController extends Controller
{
    ...
    public function create()
    {
        ...
        if($role->hasPermissionTo('purchases-add')){
            ...
            return view('purchase.create', compact('pos_setting', 'all_permission', 'lims_supplier_list', 'lims_warehouse_list', 'lims_tax_list', 'lims_product_list_without_variant', 'lims_product_list_with_variant'));
        }
        else
            return redirect()->back()->with('not_permitted', 'Sorry! You are not allowed to access this module');
    }
    ...
    public function limsProductSearch(Request $request)
    {
        ...
        $product[] = $lims_product_data->location;
        return $product;
    }
        ...
        foreach ($product_id as $i => $id) {
            ...
            if($batch_no[$i]) {
                ...
                if($product_batch_data) {
                    ...
                    $product_batch_data->location = $product_location[$i];
            ...
            $lims_product_data->location = $product_location[$i];
    ...
    public function addPayment(Request $request)
    {
        ...
        elseif ($data['paid_by_id'] == 3) {
            ...
            $lims_payment_data->sale_id = $lims_purchase_data->id;
            $lims_payment_data->account_id = $data['credit_id'];
