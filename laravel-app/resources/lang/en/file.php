...
return [
	...
	'Search On Click' => 'Search On Click',
    ...
    "Sale Zero Stock Product" => "Sale Zero Stock Product",
    "Star Sale" => "Star Sale",
    "profit percentage" => "Profit Percentage",
    "default unit" => "Default Unit",
    "default category" => "Default Category",
    "Update Bulk Product" => "Update Bulk Product",

    "order" => "Online order",
    "Order List" => "Online Order List",
    "phone" => "phone",
    "email" => "email",
    "total" => "total",
    "payment status" => "payment status",
    ...
    "MTN Momo Number" => "MTN Momo Number",
