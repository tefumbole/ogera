        ...
        <table id="role-table" class="table">
            ...
            @foreach($data as $key=>$item)
                <tr  data-id="{{$item->id}}" class="clickable-row" style="cursor: pointer" data-href="{{ route('letter.show', $item->id) }}">
                    ...
                    <td>{{ $item->subject}}</td>
                    <td><span class="badge badge-warning">Ready to Send</span></td>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default">
                                ...
                                <li>
                                    <a href="{{ route('letter.edit.last', $item->id) }}" class="btn btn-link"><i class="fa fa-pencil"></i> {{trans('file.edit')}}</a>
                                </li>
