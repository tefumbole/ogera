            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <div class="row w-100">
                            <div class="col-md-12">
                                <form method="POST" action="{{ route('letter.approve.store', [$data->id]) }}" id="letter-approve-form">
                                    @csrf
                                    @include('letter.partials.signature_pad', [
                                        'submitLabel' => 'Approve',
                                        'formId' => 'letter-approve-form',
                                        'padId' => 'approve-signature-pad',
                                        'clearId' => 'clear-approve-signature',
                                        'hiddenId' => 'approve_signature_image',
                                    ])
                                </form>
                            </div>
                        </div>
