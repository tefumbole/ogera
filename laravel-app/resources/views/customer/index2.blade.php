    ...
    <div class="container-fluid">
        ...
        <div class="row ">
            ...
            @if(in_array("visits-add", $all_permission))
                <a href="{{route('visit.create')}}" class="btn btn-info"><i class="dripicons-plus"></i> {{trans('file.Add Visit')}}</a>&nbsp;
            @endif
            </div>
        </div>
    </div>
        ...
        <table id="customer-table" class="table">
            ...
            <tbody>
                ...
                <tr data-id="{{$customer->id}}">
                    ...
                    <td>@if($customer->deposit < 0) {{ number_format(abs($customer->deposit), 2) }} @else 0 @endif </td>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" name="amount" step="any" value="{{ $fees }}" class="form-control" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
...
{{--                            @endif--}}
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" name="mtn_number" step="any" class="form-control" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
...
<script type="text/javascript">
    ...
    $("ul#ehr #customer-list-menu").addClass("active");
