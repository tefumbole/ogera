        ...
        <table id="expense-table" class="table">
            ...
            <tbody>
                ...
                <tr data-id="{{$expense->id}}">
                    ...
                    <td>{{$expense->date}}</td>
                    <td>{{ @$asset->name }}</td>
                    <td>{{ $expense->repairer_name }}</td>
                    <td>{{ $expense->repairer_phone }}</td>
                    <td>{{ $expense->repairer_address }}</td>
                    <td>{{ $expense->repairer_location }}</td>
                    <td>{{ $expense->repair_status }}</td>
...
<script type="text/javascript">
    ...
    $("ul#assets #assets-activity-menu-repair").addClass("active");
