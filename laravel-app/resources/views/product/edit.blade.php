                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 qty">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="qty" required class="form-control" step="any" value="{{ $lims_product_data->qty }}">
                                        <span class="validation-msg"></span>
                                    </div>
                                </div>
                                @if($role->hasPermissionTo('booking_module'))
                                    <div id="cost" class="col-md-4 rent_price_per_hour">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="rent_price_per_hour" required class="form-control" step="any" value="{{$lims_product_data->rent_price_per_hour}}">
                                            <span class="validation-msg"></span>
                                        </div>
                                    </div>
                                    <div id="cost" class="col-md-4 rent_price_per_day">
                                        <div class="form-group">
                                            <label>Product Rent Price / Day</label>
                                            <input type="number" name="rent_price_per_day" required class="form-control" step="any" value="{{$lims_product_data->rent_price_per_day}}">
                                            <span class="validation-msg"></span>
                                        </div>
                                    </div>
                                    <div id="cost" class="col-md-4 rent_price_per_month">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="rent_price_per_month" required class="form-control" step="any" value="{{$lims_product_data->rent_price_per_month}}">
                                            <span class="validation-msg"></span>
                                        </div>
                                    </div>
                                @endif
...
<script type="text/javascript">
    ...
    else if($("input[name='type_hidden']").val() == "donation" || $("input[name='type_hidden']").val() == "service"){
        $("input[name='cost']").prop('required',false);
        $("select[name='unit_id']").prop('required',false);
        $("input[name='file']").prop('required',false);
    ...
    $('select[name="type"]').on('change', function() {
        ...
        if($(this).val() == 'combo'){
            ...
            $("#combo").hide();
            $("input[name='price']").prop('disabled',false);
        } else if($(this).val() == 'donation' || $(this).val() == 'service'){
            $("input[name='cost']").prop('required',false);
            $("select[name='unit_id']").prop('required',false);
            $("input[name='file']").prop('required',false);
            $("input[name='file']").hide();
