        ...
        buttons: [
            {
                ...
                customize: function(doc) {
                    doc.pageMargins = [30, 50, 50, 30 ];
                    var cols = [];
                    cols[0] = {text: 'Date Range: {{ $start_date }} to {{ $end_date }}', alignment: 'left', margin:[50] };
                    var objHeader = {};
            ...
            },
            {
                ...
                customize: function(win) {
                    $(win.document.body).prepend('<h5>Sale Report: {{ $start_date }} - {{ $end_date }}</h5>');
