    ...
    <div class="table-responsive">
        <table id="role-table" class="table">
            ...
            @foreach($data as $key=>$item)
                <tr  data-id="{{$item->id}}" class="clickable-row" style="cursor: pointer" data-href="{{ route('letter.template.show', $item->id) }}">
                    <td>{{$key}}</td>
{{--                    @if($item->image)--}}
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default">
                                ...
                                <li>
                                        <a href="{{ route('letter.template.edit', $item->id) }}" class="btn btn-link"><i class="dripicons-document-edit"></i> {{trans('file.edit')}}</a>
                                    </li>
                                <li class="divider"></li>
                                @endif
                                    @if(in_array("letter_delete", $all_permission))

                                    {{ Form::open(['route' => ['letter.template.delete', $item->id], 'method' => 'DELETE'] ) }}
                                    <li>
