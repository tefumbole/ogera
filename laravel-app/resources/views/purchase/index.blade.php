...
{{--                                <option value="3">Credit Card</option>--}}
                ...
                <div class="row">
                    ...
                    <div id="cheque" class="col-md-12">
                        <div class="form-group">
                            <label>{{trans('file.Cheque Number')}} *</label>
                            <input type="text" name="cheque_no" class="form-control">
                        </div>
                    </div>
                    <div class="form-group col-md-12" id="debit">
                    ...
                    <div class="form-group col-md-6 hide" id="credit">
                        <label> {{trans('file.Credit')}}</label>
                        <select class="form-control selectpicker" name="credit_id" data-live-search="true">
                            @foreach($lims_account_list as $account)
...
<script type="text/javascript">
    ...
    $('select[name="paid_by_id"]').on("change", function() {
        ...
        if (id == 3) {
            ...
            $("#cheque").hide();
            $("#credit").show();
            $("#debit").addClass('col-md-6');
            $("#debit").removeClass('col-md-12');
        } else if (id == 4) {
            $("#cheque").show();
            $("#credit").hide();
            $("#debit").addClass('col-md-12');
            $("#debit").removeClass('col-md-6');
            $(".card-element").hide();
