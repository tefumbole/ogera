    ...
    <div class="table-responsive">
        <table id="role-table" class="table">
            ...
            @foreach($data as $key=>$item)
                <tr data-id="{{$item->id}}" class="clickable-row" style="cursor: pointer" data-href="{{ route('payment.edit', $item->id) }}">
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default">
                                    @if(in_array("payments-edit", $all_permission))
                                        <li>
                                            <a href="{{ route('payment.edit', $item->id) }}" class="btn btn-link"><i class="dripicons-document-edit"></i> {{trans('file.edit')}}</a>
                                        </li>
                                        <li class="divider"></li>
                                    @endif
                                    @if(in_array("payments-delete", $all_permission))
                                        <li>
                                            <a href="{{ route('payment.delete', $item->id) }}" onclick="return confirm('Are you sure you want to delete this item?');" class="btn btn-link"><i class="dripicons-trash"></i> Delete</a>
                                        </li>
                                    @endif
