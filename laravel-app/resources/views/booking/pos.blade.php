...
{{--                        </div>--}}
                        ...
                        <div class="column-5">
                            <button style="background-color: #e28d02" type="button" class="btn btn-custom" id="draft-btn"><i class="dripicons-flag"></i> Orange momo</button>
                        </div>
                        <div class="column-5">
                            <button style="background-color: #fd7272" type="button" class="btn btn-custom payment-btn" data-toggle="modal" data-target="#add-payment" id="cheque-btn"><i class="fa fa-money"></i> MTN momo</button>
                        </div>
                        <div class="column-5">
...
function addNewProduct(data){
    ...
    @if(in_array("price-change", $all_permission))
        cols += '<td class="col-sm-3 product-title"><button type="button" class="edit-product btn btn-link" data-toggle="modal" data-target="#editModal"><strong>' + data[0] + '</strong></button><br>' + data[1] + '<p>In Stock: <span class="in-stock"></span></p></td>';
    @else
...
@endsection
@section('scripts')
<script type="text/jm   nnnnn,avascript" src="https://js.stripe.com/v3/"></script>
