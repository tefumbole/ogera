                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default">
                                ...
                                @if(in_array("announcement_edit", $all_permission))
                                    <li>
                                        <a href="{{ route('announcement.edit', $item->id) }}" class="btn btn-link"><i class="dripicons-document-edit"></i> {{trans('file.edit')}}</a>
                                    </li>
                                    <li class="divider"></li>
                                @endif
                                @if(in_array("announcement_delete", $all_permission))
                                        <li>
                                            <a href="{{ route('announcement.destroy', $item->id) }}" onclick="return confirm('Are you sure you want to delete this item?');" class="btn btn-link"><i class="dripicons-trash"></i> Delete</a>
                                        </li>
                                @endif
                            </ul>
                        </div>
