@extends('layout.main') @section('content')
    ...
    @if(false)
    <!-- Legacy POS sidebar removed — use Beyond sidebar from layout.main -->
                    ...
                    @if($JE_active ||$average_sale_active || $profit_loss_active || $best_seller_active || $warehouse_report_active || $warehouse_stock_report_active || $product_report_active || $daily_sale_active || $monthly_sale_active || $daily_purchase_active || $monthly_purchase_active || $purchase_report_active || $sale_report_active || $payment_report_active || $product_qty_alert_active || $user_report_active || $customer_report_active || $supplier_report_active || $due_report_active)
                        <li><a href="#report" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-document-remove"></i><span>{{trans('file.Reports')}}</span></a>
                            <ul id="report" class="collapse list-unstyled ">
                                ...
                                @endif
{{--                                @if(in_array('due-customer-report', $all_permission))--}}
{{--                                    <li id="due-customer-report-menu">--}}
{{--                                        <a href="{{route('due-patient-report')}}">Creditor's Report</a>--}}
{{--                                    </li>--}}
{{--                                @endif--}}
                            </ul>
                        </li>
                ...
                <div class="col-md-6 pos-side">
                    <div class="card">
                        <div class="card-body" style="padding-bottom: 0">
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        @if(in_array("star_product", $all_permission))
                                            <div class="col-md-2">
                                                <button class="btn btn-default" data-toggle="modal" data-target="#addProduct"> <i class="fa fa-star"></i> Star Sale</button>
                                            </div>
                                        @endif
                                        @if(in_array("zero_stock", $all_permission))
                                            @if(!in_array("search_all_products", $all_permission))
                                                <div class="col-md-3">
                                                    <a class="btn btn-default" href="{{ route('sale.search.all.products') }}"> <i class="fa fa-search"></i> Search All Product</a>
                                                </div>
                                            @else
                                                <div class="col-md-3">
                                                    <a class="btn btn-default" href="{{ route('sale.search.quick.products') }}"> <i class="fa fa-search"></i> Quick Search</a>
                                                </div>
                                            @endif
                                        @endif
                                        <div class="col-md-2">
                                            <button id="toggle-btn-product" href="#" class="menu-btn btn btn-default"><i class="fa fa-bars"> </i> <span id="expend">Expend</span> </button>
                                        </div>
                                        <div class="col-md-1">
                                            <button type="button" id="pos-menu-toggle" class="menu-btn btn btn-default" title="Toggle menu"><i class="fa fa-bars"></i></button>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="search-box form-group input-group">
                                                @if(in_array("search_on_click", $all_permission))
                                                    <input type="text" name="product_code_name" id="click_productcodeSearch" placeholder="Please type product code and select..." class="form-control" />
                                                    <button class="btn btn-secondary" id="search_btn" href="javascript.void(0)"><i class="fa fa-search"></i></button>
                                                @else
                                    ...
                                    <div class="payment-options">
                                        ...
                                        {{--                        </div>--}}
                                        <div class="column-5">
                                            <button style="background-color: #213170" type="button" class="btn btn-custom payment-btn" data-toggle="modal" data-target="#add-payment" id="pay-later-btn"><i class="fa fa-paypal"></i> Send to Payment</button>
                                        </div>

                                            @if(in_array("JE-method", $all_permission))
                                                <div class="column-5">
                                                    <button style="background: #0984e3" type="button" class="btn btn-custom payment-btn" data-toggle="modal" data-target="#add-payment" id="credit-card-btn"><i class="fa fa-credit-card"></i> JE </button>
                                                </div>
                                            @endif
                                            <div class="column-5">
                                            ...
                                            <div class="column-5">
                                                <button style="background-color: #45cd27" type="button" class="btn btn-custom payment-btn" data-toggle="modal" data-target="#add-payment" id="group-credit-btn"><i class="fa fa-credit-card-alt"></i> Group Credit</button>
                                            </div>
                                            <div class="column-5">
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col-md-10">
                                                    <div class="row">
                                                        <div class="col-md-6 mt-1">
                                                            <label>{{trans('file.Total Amount')}} *</label>
                                                        ...
                                                        <div class="col-md-6 mt-1 credit">
                                                            <input type="hidden" name="credit" value="">
                                                            <label>{{trans('file.Credit')}}</label>
                                                    ...
                                                    <div class="mt-3">
                                                        <button id="submit-btn" class="btn btn-primary text-white">{{trans('file.submit')}}</button>
                                                    </div>
                                                </div>
                                                <div class="col-md-2 qc" data-initial="1">
                                                    ...
                                                    <button class="btn btn-block btn-primary qc-btn sound-btn" data-amount="1000" type="button">1,000</button>
                                                    <button class="btn btn-block btn-primary qc-btn sound-btn" data-amount="2000" type="button">2,000</button>
                                                    <button class="btn btn-block btn-primary qc-btn sound-btn" data-amount="5000" type="button">5,000</button>
                            ...
                            <div id="order-tax" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
                                <div role="document" class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group">
                                                <input type="hidden" name="order_tax_rate" id="order-tax-rate-value">
                                                <p class="text-muted small">Select one or more taxes from General Settings.</p>
                                                @foreach($lims_tax_list as $tax)
                                                    <div class="checkbox mb-2">
                                                        <input type="checkbox" class="order-tax-checkbox" value="{{$tax->rate}}" id="order-tax-{{$tax->id}}" data-name="{{$tax->name}}">
                                                        <label for="order-tax-{{$tax->id}}">{{$tax->name}} ({{$tax->rate}}%)</label>
                                                    </div>
                                                @endforeach
                                            </div>
                            ...
                            {!! Form::close() !!}
                                <!-- product list -->
                                <div class="col-md-6 products-side">
                                    <!-- navbar-->
                                    <header class="header">
                                        <nav class="navbar">
                                            <div class="container-fluid">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form>
                                    ...
                                    <hr>
                                    <div class="col-md-12 mt-2"  id="product-warehouse-table">
                                        ...
                                        <table class="table table-bordered table-hover product-warehouse-list">
                                            ...
                                            <tbody id="product-warehouse-section">
                                            </tbody>
                                        </table>
                                    </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div id="addProduct" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
                                <div role="document" class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 id="exampleModalLabel" class="modal-title">{{trans('file.add_product')}}</h5>
                                            <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
                                        </div>
                                        <div class="modal-body">
                                            <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
                                            ...
                                            <div class="form-group">
                                                <label>{{trans('file.price')}} <strong>*</strong> </label>
                                                <input type="number" name="product_price" required class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label>{{trans('file.category')}} <strong>*</strong> </label>
                                                <select required  id="product-category"  class="form-control selectpicker" name="category">
                                                    @foreach($lims_category_list as $list)
                                                        <option value="{{$list->id}}" {{ $general_setting->category == $list->id ? 'selected' : ''}}>{{$list->name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="form-group">
                                                <label>{{trans('file.unit')}} <strong>*</strong> </label>
                                                <select required id="product-unit" class="form-control selectpicker" name="unit">
                                                    @foreach($lims_unit_list as $list)
                                                        <option value="{{$list->id}}" {{ $general_setting->unit == $list->id ? 'selected' : ''}}>{{$list->unit_name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="form-group">
                                                <label>{{trans('file.profit percentage')}} *</label>
                                                <input type="text" name="profit" required class="form-control" value="{{ $general_setting->profit_percentage }}">
                                            </div>
                                            <div class="form-group">
                                                <button id="star-product" class="btn btn-primary">{{trans('file.submit')}}</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <script type="text/javascript">
        ...
        if(localStorage.getItem('pos-expend') != 1) {
            localStorage.setItem("pos-expend", 0);
        } else {
            $("#expend").html('Collapse');
            if ($(window).outerWidth() > 1199) {
                $('.products-side').hide(300);
                $('.pos-side').removeClass('col-md-6');
                $('.pos-side').addClass('col-md-12');
            } else {
                $('.products-side').hide(300);
                $('.pos-side').removeClass('col-md-6');
                $('.pos-side').addClass('col-md-12');
        ...
        $('#toggle-btn-product').on('click', function (e) {
            e.preventDefault();
            if(localStorage.getItem('pos-expend') == 1) {
                $("#expend").html('Expand');
                localStorage.setItem('pos-expend', 0);
                ...
                $("#expend").html('Collapse');
                localStorage.setItem('pos-expend', 1);
            }
            ...
            if (localStorage.getItem('pos-expend') == 1) {
                ...
                if ($(window).outerWidth() > 1199) {
                    $('.products-side').show(300);
                    $('.pos-side').addClass('col-md-6');
                    $('.pos-side').removeClass('col-md-12');
                } else {
                    $('.products-side').show(300);
                    $('.pos-side').addClass('col-md-6');
                    $('.pos-side').removeClass('col-md-12');
        ...
        var public_key = <?php echo json_encode(optional($lims_pos_setting_data)->stripe_public_key) ?>;
        ...
        var customer_owing = <?php echo json_encode($customer_owing ?? []) ?>;
        ...
        $('#order-tax-rate-value').val(getSavedValue("order-tax-rate-select") || '0');
        ...
        function changePrice(selectObject){
            rowindex = selectObject.parentNode.closest('tr').rowIndex - 1;
            product_price[rowindex] = selectObject.value;
            var edit_qty = localStorageQty[rowindex];
        ...
        $("#submit-btn").on("click", function() {
            $("#submit-btn").prop('disabled', true);  // Use 'disabled' instead of 'readonly'
            $('.payment-form').submit();
        });
        ...
        $("#pay-later-btn").on("click",function() {
            $('select[name="paid_by_id_select"]').val(9);
        ...
        $("#credit-btn").on("click",function() {
            $('select[name="paid_by_id_select"]').val(10);
            $('select[name="paid_by_id_select"]').prop('disabled', true);
            $('input[name="paid_amount"]').prop('readonly', false);
            $('input[name="paid_amount"]').prop('readonly', true);
            $('.selectpicker').selectpicker('refresh');
            $('div.qc').show();
        ...
        $("#group-credit-btn").on("click",function() {
        ...
        $('select[name="paid_by_id_select"]').on("change", function() {
            ...
            if($('input[name="paid_amount"]').val() == 0) {
                $('input[name="paid_amount"]').val($('input[name="paying_amount"]').val());
            }
        ...
        $("#star-product").click(function(e){
            e.preventDefault();
            $.ajax({
                url: '/products/store/model',
                type: "get",
                data:{
        ...
        function addNewProduct(data){
            ...
            @if(in_array("price-change", $all_permission))
                cols += '<td class="col-sm-3 product-title"><strong>' + data[0] + '</strong><br>' + data[1] + '<a class="edit-product btn btn-link" data-toggle="modal" data-target="#editModal"><i class="fa fa-pencil-square"></i></a><p>In Stock: <span class="in-stock"></span></p></td>';
            @else
                cols += '<td class="col-sm-3 product-title"><button type="button" class="edit-product btn btn-link"><strong>' + data[0] + '</strong></button><br>' + data[1] + '<p>In Stock: <span class="in-stock"></span></p></td>';
            @endif
            if(data[12]) {
                cols += '<td class="col-sm-2"><input type="text" title="'+product_expired_date[pos]+'" class="form-control batch-no product_expired_date" value="'+batch_no[pos]+'" required/> <input type="hidden" class="product-batch-id" name="product_batch_id[]" value="'+product_batch_id[pos]+'"/> </td>';
            }
            else {
            ...
            $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('.product_price_change').attr("value", product_price[rowindex]);
        ...
        function edit(){
            ...
            $('#product-warehouse-table').hide();
            $.ajax({
                url: '/sales/get-batch-products/' + product_id,
                type: "GET",
                success:function(data) {
                    $.each(data, function(key, value) {
                        $('#product-warehouse-table').show();
                        $('#product-warehouse-section').append("<tr> <td>"+ key + 1 +"</td> <td>"+ value.batch_no +"</td> <td>"+ value.expired_date +"</td> <td>"+ value.qty +"</td> </tr>");
                    });
                }
            });
        ...
        function getOrderTaxRateTotal() {
            var totalRate = 0;
            $('.order-tax-checkbox:checked').each(function() {
        ...
        function calculateGrandTotal() {
            ...
            var order_tax_rate_total = getOrderTaxRateTotal();
            localStorage.setItem("order-tax-rate-select", order_tax_rate_total);
            $('#order-tax-rate-value').val(order_tax_rate_total.toFixed(2));
            ...
            item = ++item + '(' + total_qty + ')';
            var order_tax = (subtotal - order_discount) * (order_tax_rate_total / 100);
        ...
        function cancel(rownumber) {
            ...
            $('.order-tax-checkbox').prop('checked', false);
            $('#order-tax-rate-value').val('0');
            calculateTotal();
        }
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(function () {
            $('#pos-menu-toggle').on('click', function (e) {
                e.preventDefault();
