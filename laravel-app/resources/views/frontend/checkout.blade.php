...
{{--                                <a class="btn btn-paypal"><img src="{{ asset('public/assets/imgs/page/checkout/paypal.svg') }}" alt="Ecom" width="170px"></a>--}}
                            ...
                            <div class="row">
                                ...
                                @else
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <input class="form-control font-sm"  name="phone" value="{{ auth()->user() && auth()->user()->phone ? auth()->user()->phone : '+237' }}" type="text" placeholder="Phone*" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <h5 class="font-md-bold color-brand-3 mt-15 mb-20">Shipping address</h5>
                                ...
                                @if(session()->has('cart'))
                                    ...
                                    <div class="item-wishlist">
                                        ...
                                        <div class="wishlist-price">
                                            <h4 class="color-brand-3 font-lg-bold">{{ number_format($item['price'] * $item['quantity'], 2) }} {{ $currency->code }}</h4>
                                        </div>
                                    </div>
