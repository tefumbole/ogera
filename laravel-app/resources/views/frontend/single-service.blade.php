...
{{--                                    <label class="label">-17%</label>--}}
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-4 col-md-4 col-sm-3 mb-mobile"><span class="bytext color-gray-500 font-xs font-medium">by</span><a class="byAUthor color-gray-900 font-xs font-medium" href=""> Beyond Ltd</a>
...
{{--                        <span class="bytext">by</span><a class="byAUthor" href="shop-vendor-single.html"> Ecom Tech</a>--}}
                        ...
                        <div class="box-product-price">
                                ...
                                <h3 class="color-brand-3 price-main d-inline-block mr-10">{{ number_format($product->price, 2) }} {{ $currency->code }}</h3>
                        ...
                        <div class="buy-product mt-20">
                            ...
                            <div class="box-quantity">
                                    <input class="font-xl color-brand-3 quantity-product" type="hidden" value="1">

                                <div class="mt-20 box-btn-cart"><a class="btn btn-cart" href="{{ route('single.service', ['id' => $product->id] ) }}">Get Service</a></div>

                            </div>
                        </div>
{{--                        <div class="border-bottom pt-30 mb-20"></div><a class="mr-30" href="shop-wishlist.html"><span class="btn btn-wishlist mr-5 opacity-100 transform-none"></span><span class="font-md color-gray-900">Add to Wish list</span></a><a href="shop-compare.html"><span class="btn btn-compare mr-5 opacity-100 transform-none"></span><span class="font-md color-gray-900">Add to Compare</span></a>--}}
{{--                        <div class="mt-20"><a class="font-md color-gray-900" href="shop-compare.html">Compare with similar items</a></div>--}}
