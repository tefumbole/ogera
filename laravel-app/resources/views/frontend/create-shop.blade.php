        ...
        <section class="section-box shop-template mt-60">
            <div class="container">
                <div class="row mb-100">
                    <form method="POST" action="{{ route('create.shop') }}" id="login-form" enctype="multipart/form-data">
                        @csrf
                    <div class="col-lg-12">
                        <h3>Open A Shop</h3>
{{--                        <p class="font-md color-gray-500">Welcome back!</p>--}}
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="mb-5 font-sm color-gray-700">Shop Name</label>
                                    <input class="form-control" name="company_name" type="text" placeholder="Shop Name">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="mb-5 font-sm color-gray-700">Vendor Image</label>
                            ...
                            <div class="form-group">
                                <input class="font-md-bold btn btn-buy" type="submit" value="Create Shop">
                            </div>
