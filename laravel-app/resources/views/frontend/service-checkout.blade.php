                            ...
                            <div class="box-border">
                                ...
                                <div class="row">
                                    ...
                                    @if(!auth()->user())
                                        ...
                                        <div class="col-lg-12">
                                            <h5 class="font-md-bold color-brand-3 text-sm-start text-center my-3">Upload Your Doc</h5>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <input class="form-control" name="customer_doc" type="file" required>
                                            </div>
                                        </div>
                                    @else
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <input class="form-control font-sm"  name="phone" value="{{ auth()->user() && auth()->user()->customer ? auth()->user()->customer->phone_number : '+237' }}" type="text" placeholder="Phone*" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <h5 class="font-md-bold color-brand-3 mt-15 mb-20">Shipping address</h5>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <input class="form-control font-sm"  name="name" value="{{ auth()->user() && auth()->user()->customer ? auth()->user()->customer->name : '' }}"type="text" placeholder="name*" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        <div class="box-border">
                            ...
                            <div class="form-group mb-0">
                                ...
                                <div class="row mb-10">
                                    <div class="col-lg-3 col-3"><span class="font-md-bold color-brand-3">Detail</span></div>
                                    <div class="col-lg-9 col-9 text-end">{!! $product->product_details !!}</div>
                                </div>
                                <hr>
                                <div class="row mb-10">
                                    <div class="col-lg-6 col-6"><span class="font-md-bold color-brand-3">Subtotal</span></div>
                                    <div class="col-lg-6 col-6 text-end"><span class="font-lg-bold color-brand-3">{{ number_format($product->price, 2) }} {{ $currency->code }}</span></div>
                                </div>
                                <div class="row">
