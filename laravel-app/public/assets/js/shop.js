(function ($) {
    ...
    $(document).on("click", function (event) {
        var $trigger = $(".box-dropdown-rent-cart");
        if ($trigger !== event.target && !$trigger.has(event.target).length) {
            $(".dropdown-rent-account").removeClass("dropdown-open");
            $(".dropdown-rent-cart").removeClass("dropdown-open");
        }
    });
    ...
    $("#icon-rent-cart").on("click", function () {
        $(".dropdown-rent-cart").toggleClass("dropdown-open");
    });
